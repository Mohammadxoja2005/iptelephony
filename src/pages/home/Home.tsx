...
const Home: FC = () => {
    return (
        <div className='paged'>
            ...
            <div className="percentage" style={{ width: "100%", display: "none" }} />
...
54 98 87 168 34 70 67 128 74 128 6 0 49 -14 95 -31z"/>
                    ...
                    >
                        ...
                        <ul className="menu-list advantage-list">
                            ...
                            <li className="advantage-list_item">
                                Быстрое подключение. Специалистам компании «Alex Technical»
                    ...
                    >
                        ...
                        <p className="service-intro_description">
                            Вторая проблема, которую компания «Alex Technical» с большим успехом
                        ...
                        <h2 className="service-advantages_heading">
                            ...
                            <span className="golden"> «под ключ» </span> от компании <br /> «Alex
                            Technical»
                        </h2>
                        <p className="service-intro_description">
                        ...
                        <p className="service-intro_description">
                            ...
                            компании «Alex Technical» огромный опыт проектирования и внедрения
            ...
            >
                ...
                <div style={{ zIndex: 2000000000, position: "relative" }}>
                    <iframe
                        ...
                        src="https://www.google.com/recaptcha/api2/bframe?hl=en&v=IqA9DpBOUJevxkykws9RiIBs&k=6LeOfu0gAAAAAHrNsQrPoNR2A0H7Ljtvg0SwJ6Gm"
                        name="c-5wb0v2ntuyo7"
                        frameBorder={0}
                        scrolling="no"
                        sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"
